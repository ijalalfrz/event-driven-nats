...
if [ "$APP_ENV" = "development" ]; then
    export DB_DSN="postgres://postgres@postgres-user-service/user_development?sslmode=disable"
else
    export DB_DSN="postgres://postgres@postgres-user-service/user_test?sslmode=disable"
fi
